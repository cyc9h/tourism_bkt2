...
while($row = mysqli_fetch_array($hasil))
	...
	//DATA GALLERY
    $query_gallery="SELECT serial_number, gallery_culinary FROM culinary_gallery where id = '".$info."' ";
