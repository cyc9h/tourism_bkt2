      ...
      *********************************************************************************************************************************************************** -->
		      ...
		      <form class="form-login" action="act/session.php" method="post">
		        ...
		        <div class="login-wrap">       
		            ...
		            <button class="btn btn-theme btn-block" type="submit" name="submit" style ="background-color: #1685e5"><i class="fa fa-lock" ></i> LOG IN</button>&nbsp
                <center><a href="pages/register.php">Create an account</a></center>
